...
var mpl = __importStar(require("@metaplex-foundation/mpl-token-metadata"));
var web3 = __importStar(require("@solana/web3.js"));
var anchor = __importStar(require("@project-serum/anchor"));
var data = require("../config/metadata.json");
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var myKeypair, mint, seed1, seed2, seed3, _a, metadataPDA, _bump, accounts, dataV2, args, ci, tx, connection, txid;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    console.log("Updating metadata for existing metadata account");
                    myKeypair = loadWalletKey("C:/Users/profe/.config/solana/id.json");
                    console.log(myKeypair.publicKey.toBase58());
                    mint = new web3.PublicKey("HARcNpSQ5zZ2dCci2bg91w9K4pkv222mS9fQMKwQBpxe");
                    ...
                    dataV2 = {
                        name: data.name,
                        symbol: "FNRZR",
                        image: "https://raw.githubusercontent.com/BCusack/crypto/main/logo.png",
                    ...
                    ci = mpl.createUpdateMetadataAccountV2Instruction(accounts, args);
