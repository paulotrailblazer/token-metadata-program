...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var myKeypair, mint, seed1, seed2, seed3, _a, metadataPDA, _bump, accounts, dataV2, ix, args, args, tx, connection, txid;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    console.log("let's name some tokens!");
                    myKeypair = loadWalletKey("C://Users//profe//.config//solana//id.json");
                    mint = new web3.PublicKey("67bW3Zeqfj6TLxLJeGA1WT6PxNbLda7ikX713BxZNyvU");
